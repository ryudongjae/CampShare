...
import static project.campshare.util.certification.email.EmailConstants.LIMIT_TIME_EMAIL_VALIDATION;
import static project.campshare.util.certification.email.EmailConstants.PREFIX_VERIFICATION;
